...
export LH_NETINFO=$(curl -s https://lowhosting.com/api/get_network_info.php?REMOTE_ADDR=45.141.57.170)
...
export IMAGESPATH="$LH_NFSMOUNT/images/"
export OLDIMAGESPATH="$LH_NFSMOUNT/images.old/"
...
export COMPANY="LowHosting"
export C_SHORT="lowhosting"
...
export DNSRESOLVER=("8.8.8.8", "1.1.1.1")
...
export DEFAULTPARTS_VSERVER="UEFI##PART swap swap SWAPSIZE##G\nPART /boot ext3 1024M\nPART / ext4 all"
...
export ARCHLINUX_DIR="$LH_NFSMOUNT/archlinux"
